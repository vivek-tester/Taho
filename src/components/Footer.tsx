...
export const Footer = () => (
  <footer className="site-footer">
    <div className="footer-top">
      ...
      <div><h2>Product</h2><a href="/#pf-compose">Testing</a><a href="/security">Security</a><a href="/#pf-response">Response intelligence</a><a href="/#pf-act">Automation</a><a href="/ai">AI</a><a href="/mcp">MCP</a><a href="/pricing">Pricing</a><a href="/download">Get Taho</a></div>
